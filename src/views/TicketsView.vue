...
.prio-medium { background-color: #f97316; }
.prio-low { background-color: #3b82f6; }
...
.badge-blue { background-color: #3b82f620; color: #3b82f6; }
.badge-orange { background-color: #f9731620; color: #f97316; }
.badge-green { background-color: #22c55e20; color: #22c55e; }
.badge-gray { background-color: #6b728020; color: #6b7280; }
</style>
